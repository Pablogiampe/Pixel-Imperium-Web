...
<form class="form-login" method="POST" action="{{ route('login') }}">
    @csrf
    <div id="login-lable">Iniciar Sesión</div>
    <input class="form-content" type="text" name="email" placeholder="Correo electrónico" />
    <input class="form-content" type="password" name="contrasena" placeholder="Contraseña" />
